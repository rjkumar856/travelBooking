...
<div class="site-content">
					...
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
							...
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                    <?php
                                    $stmt = $reg_user->runQuery("SELECT * FROM tbl_admin_customers ORDER BY id");
                                    $stmt->execute();
                                    ...
                                    <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
    										...
    										<td><?php echo $stmt1->cusFname;?></td>
    										<td><?php echo $stmt1->cusEmail;?></td>
    										<td><?php echo $stmt1->cusPhone;?></td>
    										<td><?php echo $stmt1->cusAddress1;?></td>
    										<td><?php echo $stmt1->cusCity;?></td>
										</tr><?php } ?>
								</tbody>
							</table>
						</div>
		...
		function delete_id(id){
		    if(confirm('Are you sure you want Delete this User?')){
		        window.location.href='view-admin-list?delete_id='+id;
		    }
		}
</script>
</body>

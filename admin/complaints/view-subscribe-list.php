...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>View Subscription List</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="/">Home</a></li>
							<li class="breadcrumb-item active">View Subscription List</li>
						</ol>
						<div class="box box-block bg-white">
							<h5 class="mb-1">Exporting Subscription List Data</h5>
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                <?php
                                $stmt = $reg_user->runQuery("SELECT * FROM request_subscription ORDER BY date_added DESC");
                                $stmt->execute();
                                ...
                                ?><tr>
										...
										<td><?php echo $stmt1->newsletter; ?></td>

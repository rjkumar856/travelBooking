            ...
            $FileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
                if($FileType == 'jpg' || $FileType == 'jpeg' || $FileType == 'png' || $FileType == 'gif'){
                    ...
                    if (move_uploaded_file($_FILES["result_file"]["tmp_name"], $target_file_new)){
                        ...
                        $stmt = $reg_user->runQuery("INSERT INTO north_india(title,description,no_of_days,deluxe,luxury,star,image) 
            		    VALUES('$title','$description','$no_of_days','$deluxe','$luxury','$star','$file_name')");
                        $stmt->execute();
                        
                		$_SESSION['add_user_error_msg'] = "<div class='alert alert-success'><button class='close' data-dismiss='alert'>&times;</button><strong>New North India Tour Pacakages Details!</strong> Added Successfully.</div>";
                		header("Location: add-north-india-packages");
                		exit();
                		exit();
                    } else {
...
<div class="site-content">
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Create New North India Tour Packages</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="view-north-india-packages">North India Tour Packages List</a></li>
							<li class="breadcrumb-item active"><a href="#">Add North India Packages</a></li>
						</ol>
						<div class="box box-block bg-white">
							...
							<form name="news upload" id="news" action="" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_of_days" id="no_of_days" placeholder="Enter the No. of Days" value="<?php if(isset($_POST['no_of_days'])){ echo $_POST['no_of_days']; } ?>" />
								</div>
								</div>

...
if(isset($_GET['delete_id'])){
	...
	$stmt = $reg_user->runQuery("DELETE FROM request_outstation_round WHERE id=".$_GET['delete_id']);
	$stmt->execute(array(":id"=>$id));
	header("Location: view-enquiry-round");
}
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<ol class="breadcrumb no-bg mb-1">
							...
							<li class="breadcrumb-item active">Admin Outstation Round Trip List</li>
						</ol>
						<div class="box box-block bg-white">
							...
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                                    <?php
                                    $stmt = $reg_user->runQuery("SELECT * FROM request_outstation_round ORDER BY id");
                                    $stmt->execute();
                                    ...
                                    <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
										<a href="javascript:delete_id(<?php echo $stmt1->id;?>)"><button type="submit" class="jsgrid-button jsgrid-delete-button" href="" title="Delete" name="delete-ad"></button></a>
    										...
    										<td><?php echo $stmt1->return_date;?></td>
    										<td><?php echo $stmt1->return_time;?></td>
...
{
	if(confirm('Are you sure you want to Delete this Request Outstation round Trip?'))
	{
		window.location.href='view-enquiry-round?delete_id='+id;
	}
}
</script>
            ...
            $FileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
                if($FileType == 'jpg' || $FileType == 'jpeg' || $FileType == 'png' || $FileType == 'gif'){
                    ...
                    if (move_uploaded_file($_FILES["result_file"]["tmp_name"], $target_file_new)){
                        ...
                        $stmt = $reg_user->runQuery("INSERT INTO south_india(title,description,no_of_days,deluxe,luxury,star,image) 
            		    VALUES('$title','$description','$no_of_days','$deluxe','$luxury','$star','$file_name')");
                        $stmt->execute();
                        
                		$_SESSION['add_user_error_msg'] = "<div class='alert alert-success'><button class='close' data-dismiss='alert'>&times;</button><strong>New South India Tour Packages Details!</strong> Added Successfully.</div>";
                		header("Location: add-south-india-packages");
                		exit();
                		exit();
                    } else {
...
<div class="site-content">
				<div class="content-area py-1">
					<div class="container-fluid">
						<h4>Create New South India Tour Packages</h4>
						<ol class="breadcrumb no-bg mb-1">
							<li class="breadcrumb-item"><a href="view-south-india-packages">South India Tour Packages List</a></li>
							<li class="breadcrumb-item active"><a href="#">Add South India Tour Packages</a></li>
						</ol>

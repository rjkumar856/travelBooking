							...
							<div class="col-md-12 col-sm-12 col-xs-12 bookingform-details">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active fade in" id="search1">
													...
													<div class="row">
														<div class="col-md-3 col-sm-6 col-xs-12">
															...
															<div class="input-group datepicker" id="datepicker">
																<input type='text' class="form-control" name="round_start_date" required/>
														...
														<div class="col-md-3 col-sm-6 col-xs-12">
															...
															<div class="input-group datepicker" id="datepicker2">
																<input type='text' class="form-control" name="round_return_date" required/>
																<span class="input-group-addon add-on">
																	<img src="<?php echo base_url(); ?>assets/images/clander.png" alt="clander" width="18" height="19"/>
																</span>
															</div>
												...
												<div class="form-group col-md-12 no-padding">
													...
													<div class="row">
														<div class="col-md-3 col-sm-2 col-xs-4">
															...
															<input class="form-control" required placeholder="Name" name="round_name" type="text">
														</div>
														<div class="col-md-3 col-sm-5 col-xs-4">
															<input class="form-control" required placeholder="Mobile" name="round_mobile" type="text">
														</div>
														<div class="col-md-3 col-sm-5 col-xs-4">
															<input class="form-control" required placeholder="Email ID" name="round_email" type="text">
														</div>
														<div class="col-md-3 col-sm-5 col-xs-4 select-options">
															<select class="form-control" name="round_car" required>
															   <option>Select Car</option>
															   <option value="Tata Indica Non Ac">Tata Indica Non Ac</option>
															   <option value="Tata Indica Ac">Tata Indica Ac</option>
															   <option value="Etios">Etios</option>
															   <option value="Dzire">Dzire</option>
															   <option value="Xcent Ac">Xcent Ac</option>
															   <option value="Toyota Innova Ac">Toyota Innova Ac</option>
															   <option value="Toyota Innova Crysta Ac">Toyota Innova Crysta Ac</option>
										...
										<?php echo form_open('outstation-one-way-trip-submit', 'class="booking-form" id="booking-form-one-way"'); ?>
										<div class="alert alert-danger" style="<?php if(validation_errors()){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>"><?php if(validation_errors()){echo validation_errors();} ?></div>
                                        <div class="alert alert-success" style="<?php if(isset($message)){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>"><?php if(isset($message)){ echo $message;} ?></div>
                                        <div class="alert alert-success" style="<?php if($this->session->flashdata('message')){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>"><?php if($this->session->flashdata('message')){ echo $this->session->flashdata('message'); } ?></div>
											<div class="row">
												<div class="form-group col-md-12 no-padding">
													<div class="row">
														<div class="form-group col-md-6 booking_location">
															...
															<input class="form-control" required="" placeholder="Location" type="text" name="one_pickup_location">
														</div>
														<div class="form-group col-md-6 booking_location">
															<label>Where do you want to go?</label>
															<input class="form-control" required="" placeholder="Location" name="one_drop_location" type="text">
														</div>
													</div>
												</div>
												...
												<div class="form-group col-md-12 no-padding">
													<div class="row">
														<div class="col-md-3 col-sm-6 col-xs-12">
															<label>Travel Start Date</label>
															<div class="input-group datepicker" id="datepicker">
																<input type='text' class="form-control" name="one_start_date" required/>
																<span class="input-group-addon add-on">
																	<img src="<?php echo base_url(); ?>assets/images/clander.png" alt="clander" width="18" height="19"/>
																</span>
															</div>
												...
												<div class="form-group col-md-12 no-padding">
													...
													<div class="row">
														<div class="col-md-3 col-sm-2 col-xs-4">
															<input class="form-control" required placeholder="Name" name="one_name" type="text">
														</div>
														<div class="col-md-3 col-sm-5 col-xs-4">
															<input class="form-control" required placeholder="Mobile" name="one_mobile" type="text">
														</div>
														<div class="col-md-3 col-sm-5 col-xs-4">
															<input class="form-control" required placeholder="Email ID" name="one_email" type="text">
														</div>
														<div class="col-md-3 col-sm-5 col-xs-4 select-options">
															<select class="form-control" name="one_car" required>

						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12 bookingform-details">
								...
								<ul class="nav nav-tabs" role="tablist">
									<li role="presentation" class="active"><a href="#search1" aria-controls="search1" role="tab" data-toggle="tab"><img src="<?php echo base_url(); ?>assets/images/photoslider2-ic3.png" alt="photoslider2-ic3" width="22" height="23">Outstation One Way Trip</a></li>
								</ul>
									...
									<div class="col-md-6 col-sm-12 no-padding">
										<div class="popular_des2_content-block">
											...
											<ul>
												...
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic2.png" alt="popular-destination2-ic2" width="24" height="24">Rate: Rs 18.00/km</li>
								...
								<div class="row">
									<div class="col-md-6 col-sm-12 no-padding">
										<div class="popular_des2_content-block" style="padding: 40px 30px 10px;">
											...
											<p>Distance and time will start at customer pickup point and end at the drop point.</br>Driver Charges will be extra if the driver on duty before 6 am or after 10 pm.</br>Day means Calender day.</br>State entry tax, Parking, and tolls will be charged extra.<br><b>Booking:</b> 10% booking advance</br><b>Pickup & Drop:</b> Office to office</p>
											<ul>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic1.png" alt="popular-destination2-ic1" width="24" height="24">Seating: 6+Driver</li>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic2.png" alt="popular-destination2-ic2" width="24" height="24">Rate: Rs 22.00/km</li>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic3.png" alt="popular-destination2-ic3" width="28" height="27">Driver Allowance: Rs.300</li>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic4.png" alt="popular-destination2-ic4" width="28" height="28">Min Km Per Day: 300kms</li>
											</ul>
									...
									<div class="col-md-6 col-sm-12 no-padding">
										<div class="popular_des2_content-block" style="padding: 40px 30px 10px;">
											...
											<ul>
												...
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic2.png" alt="popular-destination2-ic2" width="24" height="24">Rate: Rs 45.00/km</li>
								...
								<div class="row">
									<div class="col-md-6 col-sm-12 no-padding">
										<div class="popular_des2_content-block">
											...
											<ul>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic1.png" alt="popular-destination2-ic1" width="24" height="24">Seating: 4+Driver</li>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic2.png" alt="popular-destination2-ic2" width="24" height="24">Rate: Rs 60.00/km</li>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic3.png" alt="popular-destination2-ic3" width="28" height="27">Driver Allowance: Rs.300</li>
												<li><img src="<?php echo base_url(); ?>assets/images/popular-destination2-ic4.png" alt="popular-destination2-ic4" width="28" height="28">Min Km Per Day: 300kms</li>
											</ul>
